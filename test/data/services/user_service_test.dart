  ...
  group('UserService', () {
    ...
    test('credencials invàlides llança error (400)', () async {
      ...
      expect(
        ...
        throwsA(isA<Exception>().having((e) => e.toString(), 'message', contains('Invalid login credentials'))),
      );
    });
    ...
    test('error servidor llança excepció (500)', () async {
      ...
      expect(
        ...
        throwsA(isA<Exception>().having((e) => e.toString(), 'message', contains('Login error'))),
      );
    });
  });
}
