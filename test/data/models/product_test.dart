...
void main() {
  ...
  test('fica valor per defecte en nulls/string buida', () {
    ...
    expect(
      empty.createdAt.difference(DateTime.now()).inSeconds.abs(),
      lessThan(2),
    );
    ...
    expect(
      nullDate.createdAt.difference(DateTime.now()).inSeconds.abs(),
      lessThan(2),
    );
