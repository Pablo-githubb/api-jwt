...
void main() {
  ...
  test('error al crear producte', () async {
    mockProductRepository.exceptionToThrow = Exception('Failed to create');
  ...
  test('error al eliminar producte', () async {
    mockProductRepository.exceptionOnDelete = Exception('Delete failed');
  ...
  test('error al carregar productes', () async {
    mockProductRepository.exceptionOnGet = Exception('Failed to load products');
